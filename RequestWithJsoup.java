...
public class RequestWithJsoup {
    ...
    private boolean isPageContentContainsBlacklistedPhrases(String pageContent) {
        ...
        return pageContent.toLowerCase().contains("under construction")
                ...
                || pageContent.toLowerCase().contains("sitemiz bakımdadır")
                || pageContent.toLowerCase().contains("sitemiz bakım aşamasında")
                || pageContent.toLowerCase().contains("sitemiz bakıma girmiştir")
                || pageContent.toLowerCase().contains("sayfa bulunamadı")
